...
const SignIn = () => {
    ...
    const handleSignIn=event => {
        ...
        .then(result =>{
                ...
                const user={email, lastLogin:lastLogin}
            // here we should update data 
	...
	<form onSubmit={handleSignIn} noValidate="" action="" className="space-y-6">
		<div className="space-y-1 text-sm">
			...
			<input type="email" name="email" id="email" placeholder="abc@gmail.com" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
		</div>
		<div className="space-y-1 text-sm">
